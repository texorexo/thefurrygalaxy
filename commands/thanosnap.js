...
module.exports.run = async (bot, message, args) => {
    ...
    message.guild.ban(banUser, {days: 365, reason: reason})
...
module.exports.config = {
    name: "thanosnap",
    description: "Bans a user and deltes all his messages, making him look like he was snpped into the void!",
    usage: ".thanosnap <user> <reason>",
    accessableby: "Moderators",
    aliases: ["tsnap", "ts", "thanoss", "endgame"]
}